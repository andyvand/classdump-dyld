...
@interface BRQuery : NSObject <BRNotificationReceiverDelegate> {
	...
	SCD_Struct_BR9 _batchingParameters;
...
-(void)setCreateValueFunction:(/*function pointer*/void*)arg1 withContext:(void*)arg2 callbacks:(const SCD_Struct_BR12*)arg3 ;
-(void)setCreateResultFunction:(/*function pointer*/void*)arg1 withContext:(void*)arg2 callbacks:(const SCD_Struct_BR12*)arg3 ;
-(id)initWithQuery:(id)arg1 values:(id)arg2 sortingAttributes:(id)arg3 items:(id)arg4 ;
-(void)setBatchingParameters:(SCD_Struct_BR9)arg1 ;
