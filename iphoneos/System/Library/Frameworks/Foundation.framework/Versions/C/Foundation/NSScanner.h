...
-(char)safari_scanUpToAndIncludingString:(id)arg1 intoString:(id*)arg2 ;
-(char)safari_scanUpToAndIncludingCharactersFromSet:(id)arg1 intoString:(id*)arg2 ;
...
-(char)scanDecimal:(SCD_Struct_NS27*)arg1 ;
-(char)caseSensitive;
