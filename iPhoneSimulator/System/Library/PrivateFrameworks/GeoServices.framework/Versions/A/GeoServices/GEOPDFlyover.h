...
@property (nonatomic,readonly) SCD_Struct_GE180* cameraPaths; 
...
@property (nonatomic,readonly) SCD_Struct_GE181* labelFrames; 
...
-(void)copyTo:(id)arg1 ;
-(SCD_Struct_GE180)cameraPathAtIndex:(unsigned long long)arg1 ;
-(unsigned long long)cameraPathsCount;
-(void)addCameraPath:(SCD_Struct_GE180)arg1 ;
-(char)useSplines;
-(unsigned long long)labelFramesCount;
-(SCD_Struct_GE181)labelFrameAtIndex:(unsigned long long)arg1 ;
...
-(void)addLabelFrame:(SCD_Struct_GE181)arg1 ;
...
-(SCD_Struct_GE180*)cameraPaths;
-(void)setCameraPaths:(SCD_Struct_GE180*)arg1 count:(unsigned long long)arg2 ;
-(void)setUseSplines:(char)arg1 ;
-(void)setHasUseSplines:(char)arg1 ;
-(char)hasUseSplines;
-(SCD_Struct_GE181*)labelFrames;
-(void)setLabelFrames:(SCD_Struct_GE181*)arg1 count:(unsigned long long)arg2 ;
-(void)dealloc;
-(id)description;
