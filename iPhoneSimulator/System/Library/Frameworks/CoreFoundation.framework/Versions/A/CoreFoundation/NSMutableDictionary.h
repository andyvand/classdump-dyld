...
-(void)setFourCharCodeFE_FI:(unsigned)arg1 forKey:(id)arg2 ;
...
-(void)setSizeFE_FI:(const CGSize*)arg1 forKey:(id)arg2 ;
-(void)setPointFE_FI:(const CGPoint*)arg1 forKey:(id)arg2 ;
-(void)setRectFE_FI:(const CGRect*)arg1 forKey:(id)arg2 ;
