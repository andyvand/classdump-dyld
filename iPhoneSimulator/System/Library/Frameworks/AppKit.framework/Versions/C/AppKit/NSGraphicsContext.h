...
+(void)safari_makeGraphicsContextCurrentWithGraphicsPort:(void*)arg1 flipped:(char)arg2 andPerformBlock:(/*^block*/id)arg3 ;
...
+(id)colorFactory;
-(void)safari_makeCurrentAndPerformBlock:(/*^block*/id)arg1 ;
-(void)dealloc;
-(void)saveGraphicsState;
-(void)restoreGraphicsState;
-(void*)graphicsPort;
