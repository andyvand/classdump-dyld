...
@class NSTableHeaderView, NSView, NSMutableArray, NSCell, NSMutableIndexSet, NSColor, FI_TTableViewShrinkToFitController, NSArray, NSTableColumn, NSIndexSet, NSString, NSDictionary;
...
@property (readonly) FI_TTableViewShrinkToFitController * stfEditorController_FI; 
...
-(FI_TTableViewShrinkToFitController *)stfEditorController_FI;
-(CGRect)maxSTFEditorFrameForColumn_FI:(long long)arg1 row:(long long)arg2 ;
...
-(CGSize)itemClickOffset_FI:(id)arg1 ;
-(void)scrollPageUp;
-(void)scrollPageDown;
...
-(char)handleScrollKeyEvent:(id)arg1 ;
...
-(char)resizesColumnsProportionally;
-(float)constrainProposedWidth:(float)arg1 forColumn:(id)arg2 ;
-(void)collapseSelectionToSingleRow;
-(void)safari_animateScrollToPoint:(CGPoint)arg1 withVelocity:(double)arg2 completionHandler:(/*^block*/id)arg3 ;
-(CGPoint)_safari_localPointFromEvent:(id)arg1 ;
-(double)safari_intrinsicHeightConstrainedToHeight:(double)arg1 ;
-(id)columnWidths;
-(id)columnMaxWidths;
-(void)setColumnMaxWidths:(id)arg1 ;
-(void)safari_animateScrollToBeginningWithVelocity:(double)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)safari_animateScrollToEndWithVelocity:(double)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)safari_cancelAnimatedScroll;
-(char)safari_isScrolling;
