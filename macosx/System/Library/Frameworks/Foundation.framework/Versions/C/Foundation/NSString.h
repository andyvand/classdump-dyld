...
@interface NSString : NSObject <NSCopying, NSMutableCopying, NSSecureCoding, PASerializable, NSPasteboardWriting, NSPasteboardReading, CKRecordValue, CKShortDescription, ABCompare>
...
+(id)_mapkit_formattedStringForCoordinate:(SCD_Struct_NS81)arg1 ;
...
-(char)isNSString__;
-(id)camelCaseForClass:(char)arg1 ;
...
-(id)volumePath;
-(void)drawEtchedInRect_FI:(CGRect)arg1 withAttributes:(id)arg2 ;
...
-(id)fileURL;
-(NSRange)_rangeOfTabInRange:(NSRange)arg1 ;
-(char)isAppKitSupportedImageType;
-(char)isAppKitSupportedImageType;
-(id)escapedString;
-(char)isEmailAddress;
-(char)isPhoneNumber;
...
-(id)safari_simplifiedUserVisibleURLStringWithSimplifications:(unsigned long long)arg1 forDisplayOnly:(char)arg2 simplifiedStringOffset:(unsigned long long*)arg3 ;
...
-(void)safari_drawInRect:(CGRect)arg1 color:(id)arg2 font:(id)arg3 centered:(char)arg4 flipped:(char)arg5 ;
-(float)safari_widthWithFont:(id)arg1 ;
-(id)safari_stringByCenterTruncatingForMenu;
-(char)isFileURLString;
-(char)isSearchProviderHomePageURLString;
...
-(void)safari_drawInContext:(CGContextRef)arg1 atPoint:(CGPoint)arg2 withFont:(id)arg3 color:(id)arg4 ;
-(void)safari_drawInContext:(CGContextRef)arg1 atPoint:(CGPoint)arg2 withFont:(id)arg3 color:(id)arg4 flipped:(char)arg5 ;
-(id)safari_stringByDeletingTrailingSlash;
-(long long)safari_compareDomain:(id)arg1 ;
-(void)safari_drawDoubledInRect:(CGRect)arg1 withTopColor:(id)arg2 bottomColor:(id)arg3 font:(id)arg4 centered:(char)arg5 flipped:(char)arg6 topColorInFront:(char)arg7 ;
-(char)safari_looksLikeAbsoluteURLString;
-(id)safari_stringByDeletingStartingSlash;
-(void)_safari_getBottomTextPoint:(CGPoint*)arg1 topTextPoint:(CGPoint*)arg2 inRect:(CGRect)arg3 font:(id)arg4 centered:(char)arg5 flipped:(char)arg6 ;
-(id)_safari_stringByReplacingLineEndingsWithString:(id)arg1 ;
-(NSRange)safari_rangeOfURLScheme;
...
-(char)containsString:(id)arg1 options:(unsigned long long)arg2 ;
-(id)formatForDisplayIfPhoneNumber;
-(char)isMovieType;
-(char)isPassType;
-(id)idsDestination;
-(char)containsCaseInsensitiveString:(id)arg1 ;
-(char)isImageType;
-(char)isGIFType;
-(char)isEqualToBlockListAddress:(id)arg1 ;
-(id)abLabelForPerson:(id)arg1 formatWithName:(char)arg2 ;
-(id)associatedIMPerson;
-(id)abLabelForPerson:(id)arg1 ;
-(char)containsRegEx:(id)arg1 ;
-(char)containsCaseInsensitiveRegEx:(id)arg1 ;
...
-(char)isSingleByteString;
-(id)cannonicalMACAddress;
-(char)isMACAddress;
-(id)macAddressData;
-(char)isEqualToMACAddress:(id)arg1 ;
