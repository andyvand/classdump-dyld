...
-(char)hasSingleNonEmptyTrailingSelection;
-(char)willHandleArrowDownKey;
-(char)willHandleArrowUpKey;
-(char)canTakeFindStringFromSelection;
-(void)takeFindStringFromSelection:(id)arg1 ;
-(char)validate_takeFindStringFromSelection:(id)arg1 ;
