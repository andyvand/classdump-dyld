...
+(char)safari_mouseButtonIsDown;
+(id)safari_eventWithCGEvent:(CGEventRef)arg1 location:(CGPoint)arg2 ;
...
-(char)safari_isCommandRightArrowKeyDown;
-(char)safari_isCommandLeftArrowKeyDown;
-(unsigned short)safari_characterCodeWithCarbonModifiers:(unsigned)arg1 ;
-(unsigned short)safari_firstCharacterIgnoringModifiers;
-(char)safari_isDeleteKeyEvent;
-(char)safari_isCommandPeriodKeyDown;
-(char)safari_isCommandHomeKeyDown;
-(char)safari_isCommandUnderscoreAboveMinusKeyDown;
-(id)safari_eventByChangingKeyEventToCharacters:(id)arg1 ;
-(char)safari_isContextMenuEvent;
-(char)safari_isEscapeKeyEvent;
-(char)safari_isOptionTabKeyEvent;
-(char)safari_isReturnOrEnterKeyEvent;
-(char)safari_isVerticalWheelEvent;
-(char)safari_isMiddleButtonEvent;
-(char)_safari_isKeyEvent:(unsigned short)arg1 ;
-(char)_safari_isKeyDownWithCommandKeyAndKeyWithCode:(unsigned short)arg1 ;
-(char)safari_isTabKeyEvent;
-(char)safari_isWheelEvent;
-(char)safari_isDictionaryHotKeyEvent;
-(char)safari_isCommandUpArrowKeyDown;
-(char)safari_isCommandDownArrowKeyDown;
