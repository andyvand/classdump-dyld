...
@property (nonatomic,readonly) OpaqueSecKeyRefRef publicKeyFromData; 
...
+(id)dataWithPublicKey:(OpaqueSecKeyRefRef)arg1 ;
+(id)dataForNVRAMKey:(id)arg1 ;
+(id)dataWithAuthorizationRef:(AuthorizationOpaqueRefRef)arg1 ;
+(id)safari_dataWithASN1Item:(cssm_data)arg1 ;
...
-(char)isNSData__;
-(OpaqueSecKeyRefRef)publicKeyFromData;
-(id)nvramDescription;
...
-(char)safari_writeToNewURL:(id)arg1 ;
...
-(char)_ISMutableStoreIndex_addValue:(SCD_Struct_NS10*)arg1 forKey:(unsigned long long)arg2 ;
...
-(SCD_Struct_NS11*)_ISStoreIndex_header;
-(SCD_Struct_NS12*)_ISStoreIndex_nodes;
-(unsigned*)_ISStoreIndex_hashTable;
-(SCD_Struct_NS12*)_ISStoreIndex_nodeAtIndex:(unsigned)arg1 ;
...
-(char)_decodeBase64EncodedCharacterBuffer:(const char*)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 buffer:(char*)arg4 bufferLength:(unsigned long long)arg5 state:(SCD_Struct_NS13*)arg6 ;
