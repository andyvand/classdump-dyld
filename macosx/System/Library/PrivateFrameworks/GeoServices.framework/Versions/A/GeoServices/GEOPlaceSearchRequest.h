...
@interface GEOPlaceSearchRequest : PBRequest <NSCopying> {
	...
	SCD_Struct_GE57* _optionalSuppressionReasons;
	SCD_Struct_GE69 _searchContextSubstring;
	SCD_Struct_GE69* _searchSubstrings;
...
@property (nonatomic,readonly) SCD_Struct_GE69* searchSubstrings; 
...
@property (assign,nonatomic) SCD_Struct_GE69 searchContextSubstring;                            //@synthesize searchContextSubstring=_searchContextSubstring - In the implementation block
...
-(SCD_Struct_GE69)searchSubstringAtIndex:(unsigned long long)arg1 ;
-(void)addSearchSubstring:(SCD_Struct_GE69)arg1 ;
...
-(SCD_Struct_GE69*)searchSubstrings;
-(void)setSearchSubstrings:(SCD_Struct_GE69*)arg1 count:(unsigned long long)arg2 ;
-(void)setIncludeGeoId:(char)arg1 ;
-(void)setHasIncludeGeoId:(char)arg1 ;
-(char)hasIncludeGeoId;
-(char)hasSearchContext;
-(void)setSearchContextSubstring:(SCD_Struct_GE69)arg1 ;
...
-(SCD_Struct_GE69)searchContextSubstring;
