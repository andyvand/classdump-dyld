...
* Image Source: /Library/Frameworks/PluginManager.framework/Versions/A/PluginManager
* classdump-dyld is licensed under GPLv3, Copyright © 2013 by Elias Limneos.
*/

#import <PluginManager/PluginManager-Structs.h>
#import <PluginManager/PROApiAccess.h>

@class NSMutableDictionary, NSMutableArray;

@interface PROPluginManager : NSObject <PROApiAccess> {
...
+(id)pluginManager;
+(id)pluginManagerWithPluginCacheFileURL:(id)arg1 ;
...
-(id)initWithPluginCacheFileURL:(id)arg1 ;
-(int)cachePluginRegistryToURL:(id)arg1 atomically:(char)arg2 ;
-(int)addApiObject:(id)arg1 forProtocol:(id)arg2 ;
-(id)init;
-(void)dealloc;
@end
