...
@interface IOBluetoothAudioFormatControl : IOBluetoothAudioControl {

	unsigned _format;
	NSMutableDictionary* _availableFormats;

}

@property (assign) unsigned format;                                     //@synthesize format=_format - In the implementation block
@property (retain) NSMutableDictionary * availableFormats;              //@synthesize availableFormats=_availableFormats - In the implementation block
...
-(void)setAvailableFormats:(NSMutableDictionary *)arg1 ;
-(NSMutableDictionary *)availableFormats;
-(id)init;
