...
@interface BKILMediaBrowserImageMatrix : NSMatrix {
	...
	dispatch_queue_sRef _imageRenderDispatchQueue;

}
+(void)initialize;
-(void)layoutCells;
-(void)addImageRenderToQueue:(id)arg1 forCell:(id)arg2 ;
-(void)_setRenderedImage:(id)arg1 forCell:(id)arg2 ;
