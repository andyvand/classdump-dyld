...
@class ILMB_APERTURE_2012_HgDatabase, ILMB_APERTURE_2012_HgKDatabaseManager, NSString, NSMutableArray, NSMutableDictionary, ILMB_APERTURE_2012_HgRidIndexEntity, ILMB_APERTURE_2012_HgLockedDictionary, ILMB_APERTURE_2012_HgLockedRidList, ILMB_APERTURE_2012_HgRidIter, NSMutableSet, ILMB_APERTURE_2012_HgKPreparedSql, ILMB_APERTURE_2012_HgLockedSet, ILMB_APERTURE_2012_HgRidList, NSCountedSet;

@interface ILMB_APERTURE_2012_HgEntity : NSObject {

	int _spinlock;
	ILMB_APERTURE_2012_HgDatabase* _database;
	ILMB_APERTURE_2012_HgKDatabaseManager* _databaseManager;
	NSString* _tableName;
	...
	ILMB_APERTURE_2012_HgRidIndexEntity* _ridIndexEntity;
	Class _modelClass;
	char _canPrepareSql;
	...
	ILMB_APERTURE_2012_HgLockedDictionary* _cachedModelsByUuid;
	ILMB_APERTURE_2012_HgLockedDictionary* _cachedModelsById;
	ILMB_APERTURE_2012_HgLockedRidList* _cachedModelIdList;
	ILMB_APERTURE_2012_HgRidIter* _flushModelIdIterator;
	opaque_pthread_rwlock_t _cachedModelsLock;
	NSMutableSet* _cachedModels;
	NSString* _allFieldsList;
	NSString* _autoLoadFieldList;
	ILMB_APERTURE_2012_HgKPreparedSql* _persistModelSql;
	ILMB_APERTURE_2012_HgKPreparedSql* _copyRecordSql;
	ILMB_APERTURE_2012_HgLockedDictionary* _commonQueries;
	ILMB_APERTURE_2012_HgLockedDictionary* _commonDistinctQueries;
	ILMB_APERTURE_2012_HgLockedDictionary* _commonUpdates;
	ILMB_APERTURE_2012_HgLockedDictionary* _commonModifies;
	ILMB_APERTURE_2012_HgLockedDictionary* _commonMultiUpdates;
	ILMB_APERTURE_2012_HgLockedDictionary* _commonDeletes;
	ILMB_APERTURE_2012_HgLockedDictionary* _inMemoryFilters;
	ILMB_APERTURE_2012_HgLockedDictionary* _entityMemoryFilters;
	ILMB_APERTURE_2012_HgLockedSet* _reusableStrings;
	ILMB_APERTURE_2012_HgLockedDictionary* _ridIndexes;
	ILMB_APERTURE_2012_HgLockedDictionary* _ridIndexesByFieldName;
	ILMB_APERTURE_2012_HgRidList* _allModelIds;
	NSCountedSet* _allQueriesUsed;
	NSCountedSet* _couldHaveBeenInMemory;
	unsigned long long _indentLevel;
	ILMB_APERTURE_2012_HgLockedDictionary* _relationshipCaches;

}

@property (nonatomic,retain) ILMB_APERTURE_2012_HgRidIndexEntity * ridIndexEntity;              //@synthesize ridIndexEntity=_ridIndexEntity - In the implementation block
...
-(void)setRidIndexEntity:(ILMB_APERTURE_2012_HgRidIndexEntity *)arg1 ;
...
-(ILMB_APERTURE_2012_HgRidIndexEntity *)ridIndexEntity;
-(char)_logErrors;
