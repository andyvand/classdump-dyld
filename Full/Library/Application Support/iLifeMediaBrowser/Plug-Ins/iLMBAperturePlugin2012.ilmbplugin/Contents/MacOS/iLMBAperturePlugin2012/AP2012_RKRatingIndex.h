...
@class AP2012_RKDatabase, AP2012_RKMainRatingIndex, ILMB_APERTURE_2012_HgBoolRidIndex;

@interface AP2012_RKRatingIndex : NSObject {

	int _spinlock;
	AP2012_RKDatabase* _database;
	AP2012_RKMainRatingIndex* _mainRatingIndex;
	ILMB_APERTURE_2012_HgBoolRidIndex* _blankMasterVersionIds;
