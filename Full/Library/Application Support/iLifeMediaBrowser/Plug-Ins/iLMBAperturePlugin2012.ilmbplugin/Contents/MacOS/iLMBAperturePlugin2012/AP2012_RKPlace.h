...
@interface AP2012_RKPlace : AP2012_RKModel {
...
+(id)orderedPlacesByType:(id)arg1 limitToGreaterThanOrEqual:(int)arg2 ;
+(id)userDefinedPlacesForSearchStringPrefix:(id)arg1 forDatabase:(id)arg2 ;
+(id)filterToPlaces:(id)arg1 notInGeoLookups:(id)arg2 ;
