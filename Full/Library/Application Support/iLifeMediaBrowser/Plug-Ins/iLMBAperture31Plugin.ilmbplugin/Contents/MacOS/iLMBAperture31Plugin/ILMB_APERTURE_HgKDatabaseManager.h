...
@class NSRecursiveLock, NSString, NSMutableDictionary, ILMB_APERTURE_HgKResultSet, NSMutableSet, ILMB_APERTURE_HgBlockQueue, ILMB_APERTURE_HgKPreparedSql;

@interface ILMB_APERTURE_HgKDatabaseManager : NSObject {
	...
	ILMB_APERTURE_HgKResultSet* _activeResultSet;
	NSMutableSet* _preparedStatements;
	unsigned _sqlErrorCount;
	unsigned long long _uncommittedUpdates;
	ILMB_APERTURE_HgBlockQueue* _backgroundWriteQueue;
	ILMB_APERTURE_HgKPreparedSql* _commitSql;
	ILMB_APERTURE_HgKPreparedSql* _beginTransactionSql;
