...
@class NSNumber, NSString, AP31_RKMultiItemQuery, NSMutableArray, AP31_RKCustomSortOrder, NSRecursiveLock, NSMutableDictionary, ILMB_APERTURE_HgRidList, NSDate, NSSet;

@interface AP31_RKAlbum : AP31_RKModel {

	NSNumber* m_albumType;
	NSNumber* m_albumSubclass;
	NSString* m_name;
	AP31_RKMultiItemQuery* m_userQuery;
	AP31_RKMultiItemQuery* m_filter;
	...
	ILMB_APERTURE_HgRidList* m_selectedVersionIds;
	NSDate* m_createDate;
	CFArrayRef m_observers;
	NSString* m_themeName;
	NSSet* m_projectUuidsInSeachArea;
	ILMB_APERTURE_HgRidList* m_versionIdsInSearchArea;
