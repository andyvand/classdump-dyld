...
@class ILMB_APERTURE_HgKPreparedSql, NSLock, NSMutableDictionary;

@interface AP31_RKUniqueStringEntity : ILMB_APERTURE_HgEntity {

	ILMB_APERTURE_HgKPreparedSql* m_createStringSql;
	NSLock* m_stringCacheLock;
	NSMutableDictionary* m_stringsById;
	NSMutableDictionary* m_stringIdByString;
