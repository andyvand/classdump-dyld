...
@class ILMB_APERTURE_HgKPreparedSql, NSLock, NSMutableDictionary, ILMB_APERTURE_HgCharIndexEntity;

@interface ILMB_APERTURE_HgUniqueStringEntity : ILMB_APERTURE_HgEntity {

	ILMB_APERTURE_HgKPreparedSql* _createStringSql;
	NSLock* _stringCacheLock;
	NSMutableDictionary* _stringsById;
	NSMutableDictionary* _stringIdByString;
	char _allStringsCached;
	ILMB_APERTURE_HgCharIndexEntity* _charIndexEntity;

}

@property (nonatomic,retain) ILMB_APERTURE_HgCharIndexEntity * charIndexEntity;              //@synthesize charIndexEntity=_charIndexEntity - In the implementation block
...
-(void)setCharIndexEntity:(ILMB_APERTURE_HgCharIndexEntity *)arg1 ;
...
-(ILMB_APERTURE_HgCharIndexEntity *)charIndexEntity;
