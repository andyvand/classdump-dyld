...
@class NSString, AP31_RKCustomSortOrder, NSDate, NSNumber, NSMutableArray, NSRecursiveLock, ILMB_APERTURE_HgLockedSet;

@interface AP31_RKFolder : AP31_RKModel {
	...
	ILMB_APERTURE_HgLockedSet* m_directChildFolderCache;
	ILMB_APERTURE_HgLockedSet* m_directChildAlbumCache;
