...
@class ILMB_APERTURE_HgDatabase, ILMB_APERTURE_HgKDatabaseManager, NSString, NSMutableArray, NSMutableDictionary, ILMB_APERTURE_HgRidIndexEntity, ILMB_APERTURE_HgLockedDictionary, ILMB_APERTURE_HgLockedRidList, ILMB_APERTURE_HgRidIter, NSMutableSet, ILMB_APERTURE_HgKPreparedSql, ILMB_APERTURE_HgLockedSet, ILMB_APERTURE_HgRidList, NSCountedSet;

@interface ILMB_APERTURE_HgEntity : NSObject {

	int _spinlock;
	ILMB_APERTURE_HgDatabase* _database;
	ILMB_APERTURE_HgKDatabaseManager* _databaseManager;
	NSString* _tableName;
	...
	ILMB_APERTURE_HgRidIndexEntity* _ridIndexEntity;
	Class _modelClass;
	char _canPrepareSql;
	...
	ILMB_APERTURE_HgLockedDictionary* _cachedModelsByUuid;
	ILMB_APERTURE_HgLockedDictionary* _cachedModelsById;
	ILMB_APERTURE_HgLockedRidList* _cachedModelIdList;
	ILMB_APERTURE_HgRidIter* _flushModelIdIterator;
	opaque_pthread_rwlock_t _cachedModelsLock;
	NSMutableSet* _cachedModels;
	NSString* _allFieldsList;
	NSString* _autoLoadFieldList;
	ILMB_APERTURE_HgKPreparedSql* _persistModelSql;
	ILMB_APERTURE_HgKPreparedSql* _copyRecordSql;
	ILMB_APERTURE_HgLockedDictionary* _commonQueries;
	ILMB_APERTURE_HgLockedDictionary* _commonDistinctQueries;
	ILMB_APERTURE_HgLockedDictionary* _commonUpdates;
	ILMB_APERTURE_HgLockedDictionary* _commonModifies;
	ILMB_APERTURE_HgLockedDictionary* _commonMultiUpdates;
	ILMB_APERTURE_HgLockedDictionary* _commonDeletes;
	ILMB_APERTURE_HgLockedDictionary* _inMemoryFilters;
	ILMB_APERTURE_HgLockedDictionary* _entityMemoryFilters;
	ILMB_APERTURE_HgLockedSet* _reusableStrings;
	ILMB_APERTURE_HgLockedDictionary* _ridIndexes;
	ILMB_APERTURE_HgLockedDictionary* _ridIndexesByFieldName;
	ILMB_APERTURE_HgRidList* _allModelIds;
	NSCountedSet* _allQueriesUsed;
	NSCountedSet* _couldHaveBeenInMemory;
	unsigned long long _indentLevel;
	ILMB_APERTURE_HgLockedDictionary* _relationshipCaches;

}

@property (nonatomic,retain) ILMB_APERTURE_HgRidIndexEntity * ridIndexEntity;              //@synthesize ridIndexEntity=_ridIndexEntity - In the implementation block
...
-(void)setRidIndexEntity:(ILMB_APERTURE_HgRidIndexEntity *)arg1 ;
...
-(ILMB_APERTURE_HgRidIndexEntity *)ridIndexEntity;
-(char)_logErrors;
