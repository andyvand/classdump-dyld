...
@interface IP2012_RKAlbumVersionEntity : IP2012_RKEntity
-(id)initWithTableName:(id)arg1 forDatabaseManager:(id)arg2 forDatabase:(id)arg3 ;
-(void)createAlbumVersionForAlbumId:(id)arg1 versionId:(id)arg2 ;
-(void)createAlbumVersionForAlbumId:(id)arg1 versionIds:(id)arg2 ;
-(id)persistFields;
@end
