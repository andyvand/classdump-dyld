...
@class NSRecursiveLock, NSString, NSMutableDictionary, ILMB_IPHOTO_2012_HgKResultSet, NSMutableSet, ILMB_IPHOTO_2012_HgBlockQueue, ILMB_IPHOTO_2012_HgKPreparedSql;

@interface ILMB_IPHOTO_2012_HgKDatabaseManager : NSObject {
	...
	ILMB_IPHOTO_2012_HgKResultSet* _activeResultSet;
	NSMutableSet* _preparedStatements;
	unsigned _sqlErrorCount;
	unsigned long long _uncommittedUpdates;
	ILMB_IPHOTO_2012_HgBlockQueue* _backgroundWriteQueue;
	ILMB_IPHOTO_2012_HgKPreparedSql* _commitSql;
	ILMB_IPHOTO_2012_HgKPreparedSql* _beginTransactionSql;
