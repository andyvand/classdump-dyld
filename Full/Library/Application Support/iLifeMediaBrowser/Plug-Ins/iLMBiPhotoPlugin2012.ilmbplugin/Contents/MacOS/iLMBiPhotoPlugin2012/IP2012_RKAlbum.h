...
@class NSNumber, NSString, IP2012_RKMultiItemQuery, NSMutableArray, IP2012_RKCustomSortOrder, NSRecursiveLock, NSMutableDictionary, ILMB_IPHOTO_2012_HgRidList, NSDate, ILMB_IPHOTO_2012_HgRecentChange, NSSet;

@interface IP2012_RKAlbum : IP2012_RKOpenableModel {

	NSNumber* m_albumType;
	NSNumber* m_albumSubclass;
	NSString* m_name;
	IP2012_RKMultiItemQuery* m_userQuery;
	IP2012_RKMultiItemQuery* m_filter;
	...
	ILMB_IPHOTO_2012_HgRidList* m_selectedVersionIds;
	NSDate* m_createDate;
	...
	ILMB_IPHOTO_2012_HgRidList* m_versionIdsInSearchArea;
