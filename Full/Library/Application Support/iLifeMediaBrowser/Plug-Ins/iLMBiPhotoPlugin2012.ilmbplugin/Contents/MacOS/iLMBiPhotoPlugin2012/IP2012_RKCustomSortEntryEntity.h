...
@interface IP2012_RKCustomSortEntryEntity : IP2012_RKEntity
-(id)initWithTableName:(id)arg1 forDatabaseManager:(id)arg2 forDatabase:(id)arg3 ;
-(id)loadModelFromResultSet:(id)arg1 ;
-(void)createCustomSortEntryForContainerUuid:(id)arg1 purpose:(id)arg2 objectUuid:(id)arg3 orderNumber:(unsigned long long)arg4 ;
@end
