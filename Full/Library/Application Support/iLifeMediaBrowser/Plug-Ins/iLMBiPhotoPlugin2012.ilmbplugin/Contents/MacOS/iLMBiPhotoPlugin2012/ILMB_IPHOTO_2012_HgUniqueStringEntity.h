...
@class ILMB_IPHOTO_2012_HgKPreparedSql, NSLock, NSMutableDictionary, ILMB_IPHOTO_2012_HgCharIndexEntity;

@interface ILMB_IPHOTO_2012_HgUniqueStringEntity : ILMB_IPHOTO_2012_HgEntity {

	ILMB_IPHOTO_2012_HgKPreparedSql* _createStringSql;
	NSLock* _stringCacheLock;
	NSMutableDictionary* _stringsById;
	NSMutableDictionary* _stringIdByString;
	char _allStringsCached;
	ILMB_IPHOTO_2012_HgCharIndexEntity* _charIndexEntity;

}

@property (nonatomic,retain) ILMB_IPHOTO_2012_HgCharIndexEntity * charIndexEntity;              //@synthesize charIndexEntity=_charIndexEntity - In the implementation block
...
-(void)setCharIndexEntity:(ILMB_IPHOTO_2012_HgCharIndexEntity *)arg1 ;
...
-(ILMB_IPHOTO_2012_HgCharIndexEntity *)charIndexEntity;
