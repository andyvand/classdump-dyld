...
@class NSString, IP2012_RKCustomSortOrder, NSDate, NSNumber, NSRecursiveLock, NSMutableSet, XTCronJob, NSMutableDictionary, ILMB_IPHOTO_2012_HgRecentChange, ILMB_IPHOTO_2012_HgLockedSet, NSImage, NSDictionary;

@interface IP2012_RKFolder : IP2012_RKOpenableModel {
	...
	ILMB_IPHOTO_2012_HgLockedSet* m_directChildFolderCache;
	ILMB_IPHOTO_2012_HgLockedSet* m_directChildAlbumCache;
