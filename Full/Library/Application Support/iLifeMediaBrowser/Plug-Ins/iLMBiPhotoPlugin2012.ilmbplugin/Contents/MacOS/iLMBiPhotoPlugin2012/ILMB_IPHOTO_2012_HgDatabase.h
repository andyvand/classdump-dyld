...
@class NSString, ILMB_IPHOTO_2012_HgLockedDictionary, ILMB_IPHOTO_2012_HgAdminDataEntity, NSMutableArray, ILMB_IPHOTO_2012_HgDispatchQueue;

@interface ILMB_IPHOTO_2012_HgDatabase : NSObject {
	...
	ILMB_IPHOTO_2012_HgLockedDictionary* m_entitiesByClass;
	ILMB_IPHOTO_2012_HgLockedDictionary* m_entitiesByTable;
	ILMB_IPHOTO_2012_HgAdminDataEntity* m_adminDataEntity;
	ILMB_IPHOTO_2012_HgLockedDictionary* m_databaseMgrsByName;
	char m_readOnly;
	char m_isOpen;
	char m_isVault;
	NSMutableArray* m_reservations;
	ILMB_IPHOTO_2012_HgDispatchQueue* m_backgroundActionQueue;
...
@property (nonatomic,retain) ILMB_IPHOTO_2012_HgAdminDataEntity * adminDataEntity; 
...
-(ILMB_IPHOTO_2012_HgAdminDataEntity *)adminDataEntity;
-(id)entityForTable:(id)arg1 ;
...
-(void)setAdminDataEntity:(ILMB_IPHOTO_2012_HgAdminDataEntity *)arg1 ;
