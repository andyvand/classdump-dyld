...
@class ILMB_IPHOTO_HgKPreparedSql, NSNumber;

@interface ILMB_IPHOTO_HgAdminDataEntity : ILMB_IPHOTO_HgEntity {

	ILMB_IPHOTO_HgKPreparedSql* m_updateTablePropertySql;
	ILMB_IPHOTO_HgKPreparedSql* m_updateTableBlobPropertySql;
	ILMB_IPHOTO_HgKPreparedSql* m_deletePropertySql;
