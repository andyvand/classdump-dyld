...
@class ILMB_IPHOTO_HgDatabase, ILMB_IPHOTO_HgKDatabaseManager, NSString, NSMutableArray, NSMutableDictionary, ILMB_IPHOTO_HgRidIndexEntity, ILMB_IPHOTO_HgLockedDictionary, ILMB_IPHOTO_HgLockedRidList, ILMB_IPHOTO_HgRidIter, NSMutableSet, ILMB_IPHOTO_HgKPreparedSql, ILMB_IPHOTO_HgLockedSet, ILMB_IPHOTO_HgRidList, NSCountedSet;

@interface ILMB_IPHOTO_HgEntity : NSObject {

	int _spinlock;
	ILMB_IPHOTO_HgDatabase* _database;
	ILMB_IPHOTO_HgKDatabaseManager* _databaseManager;
	NSString* _tableName;
	...
	ILMB_IPHOTO_HgRidIndexEntity* _ridIndexEntity;
	Class _modelClass;
	char _canPrepareSql;
	...
	ILMB_IPHOTO_HgLockedDictionary* _cachedModelsByUuid;
	ILMB_IPHOTO_HgLockedDictionary* _cachedModelsById;
	ILMB_IPHOTO_HgLockedRidList* _cachedModelIdList;
	ILMB_IPHOTO_HgRidIter* _flushModelIdIterator;
	opaque_pthread_rwlock_t _cachedModelsLock;
	NSMutableSet* _cachedModels;
	NSString* _allFieldsList;
	NSString* _autoLoadFieldList;
	ILMB_IPHOTO_HgKPreparedSql* _persistModelSql;
	ILMB_IPHOTO_HgKPreparedSql* _copyRecordSql;
	ILMB_IPHOTO_HgLockedDictionary* _commonQueries;
	ILMB_IPHOTO_HgLockedDictionary* _commonDistinctQueries;
	ILMB_IPHOTO_HgLockedDictionary* _commonUpdates;
	ILMB_IPHOTO_HgLockedDictionary* _commonModifies;
	ILMB_IPHOTO_HgLockedDictionary* _commonMultiUpdates;
	ILMB_IPHOTO_HgLockedDictionary* _commonDeletes;
	ILMB_IPHOTO_HgLockedDictionary* _inMemoryFilters;
	ILMB_IPHOTO_HgLockedDictionary* _entityMemoryFilters;
	ILMB_IPHOTO_HgLockedSet* _reusableStrings;
	ILMB_IPHOTO_HgLockedDictionary* _ridIndexes;
	ILMB_IPHOTO_HgLockedDictionary* _ridIndexesByFieldName;
	ILMB_IPHOTO_HgRidList* _allModelIds;
	NSCountedSet* _allQueriesUsed;
	NSCountedSet* _couldHaveBeenInMemory;
	unsigned long long _indentLevel;
	ILMB_IPHOTO_HgLockedDictionary* _relationshipCaches;

}

@property (nonatomic,retain) ILMB_IPHOTO_HgRidIndexEntity * ridIndexEntity;              //@synthesize ridIndexEntity=_ridIndexEntity - In the implementation block
...
-(void)setRidIndexEntity:(ILMB_IPHOTO_HgRidIndexEntity *)arg1 ;
...
-(ILMB_IPHOTO_HgRidIndexEntity *)ridIndexEntity;
-(char)_logErrors;
