...
@class NSString, ILMB_IPHOTO_HgLockedDictionary, ILMB_IPHOTO_HgAdminDataEntity, NSMutableArray, ILMB_IPHOTO_HgDispatchQueue;

@interface ILMB_IPHOTO_HgDatabase : NSObject {
	...
	ILMB_IPHOTO_HgLockedDictionary* m_entitiesByClass;
	ILMB_IPHOTO_HgLockedDictionary* m_entitiesByTable;
	ILMB_IPHOTO_HgAdminDataEntity* m_adminDataEntity;
	ILMB_IPHOTO_HgLockedDictionary* m_databaseMgrsByName;
	char m_readOnly;
	char m_isOpen;
	char m_isVault;
	NSMutableArray* m_reservations;
	ILMB_IPHOTO_HgDispatchQueue* m_backgroundActionQueue;
...
@property (nonatomic,retain) ILMB_IPHOTO_HgAdminDataEntity * adminDataEntity; 
...
-(ILMB_IPHOTO_HgAdminDataEntity *)adminDataEntity;
-(id)entityForTable:(id)arg1 ;
...
-(void)setAdminDataEntity:(ILMB_IPHOTO_HgAdminDataEntity *)arg1 ;
