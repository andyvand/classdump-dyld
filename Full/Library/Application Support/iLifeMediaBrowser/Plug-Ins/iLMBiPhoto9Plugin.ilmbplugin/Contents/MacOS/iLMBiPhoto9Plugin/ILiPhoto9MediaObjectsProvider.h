...
#import <iLMBiPhoto9Plugin/ILMediaObjectsProvider.h>

@class ILiPhoto9Plugin, ILMediaGroup, NSMutableArray, NSCondition, NSDate, NSNumber;

@interface ILiPhoto9MediaObjectsProvider : NSObject <ILMediaObjectsProvider> {

	ILiPhoto9Plugin* _plugin;
	ILMediaGroup* _group;
