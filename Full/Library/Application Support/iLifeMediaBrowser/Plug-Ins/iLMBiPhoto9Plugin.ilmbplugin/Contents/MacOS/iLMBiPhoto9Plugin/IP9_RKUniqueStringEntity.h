...
@class ILMB_IPHOTO_HgKPreparedSql, NSLock, NSMutableDictionary;

@interface IP9_RKUniqueStringEntity : ILMB_IPHOTO_HgEntity {

	ILMB_IPHOTO_HgKPreparedSql* m_createStringSql;
