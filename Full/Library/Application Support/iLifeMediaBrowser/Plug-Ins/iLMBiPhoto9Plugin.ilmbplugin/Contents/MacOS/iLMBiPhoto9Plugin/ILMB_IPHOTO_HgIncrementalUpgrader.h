...
@class NSString, NSMutableDictionary, ILMB_IPHOTO_HgBlockQueue;

@interface ILMB_IPHOTO_HgIncrementalUpgrader : NSObject {
	...
	ILMB_IPHOTO_HgBlockQueue* m_backgroundWritingQueue;
