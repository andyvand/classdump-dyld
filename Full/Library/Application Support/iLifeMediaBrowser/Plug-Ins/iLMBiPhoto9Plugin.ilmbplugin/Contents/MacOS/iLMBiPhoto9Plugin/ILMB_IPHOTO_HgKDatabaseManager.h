...
@class NSRecursiveLock, NSString, NSMutableDictionary, ILMB_IPHOTO_HgKResultSet, NSMutableSet, ILMB_IPHOTO_HgBlockQueue, ILMB_IPHOTO_HgKPreparedSql;

@interface ILMB_IPHOTO_HgKDatabaseManager : NSObject {
	...
	ILMB_IPHOTO_HgKResultSet* _activeResultSet;
	NSMutableSet* _preparedStatements;
	unsigned _sqlErrorCount;
	unsigned long long _uncommittedUpdates;
	ILMB_IPHOTO_HgBlockQueue* _backgroundWriteQueue;
	ILMB_IPHOTO_HgKPreparedSql* _commitSql;
	ILMB_IPHOTO_HgKPreparedSql* _beginTransactionSql;
