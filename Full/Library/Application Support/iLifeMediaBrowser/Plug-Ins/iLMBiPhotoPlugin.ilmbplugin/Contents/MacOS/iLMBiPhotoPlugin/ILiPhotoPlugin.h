...
* Image Source: /Library/Application Support/iLifeMediaBrowser/Plug-Ins/iLMBiPhotoPlugin.ilmbplugin/Contents/MacOS/iLMBiPhotoPlugin
* classdump-dyld is licensed under GPLv3, Copyright © 2013 by Elias Limneos.
*/

#import <iLMBiPhotoPlugin/iLMBiPhotoPlugin-Structs.h>
#import <iLifeMediaBrowser/ILMediaManager.h>
#import <iLMBiPhotoPlugin/ILMediaManagerPlugin_MustImplement.h>

@class NSRecursiveLock, NSImage, NSLock, NSMutableArray, NSString;

@interface ILiPhotoPlugin : ILMediaManager <ILMediaManagerPlugin_MustImplement> {

	NSRecursiveLock* _appIconLock;
	NSImage* _appIcon;
	NSLock* _watchedPathChangedLock;
	NSMutableArray* _movieGroups;
	NSMutableArray* _rolls;
	NSString* _dBasePath;
...
-(id)movieGroups;
-(id)albumsInDictionary:(id)arg1 createRollsGroup:(char)arg2 ;
-(id)allPhotos;
-(char)_resetDBasePath:(id)arg1 ;
