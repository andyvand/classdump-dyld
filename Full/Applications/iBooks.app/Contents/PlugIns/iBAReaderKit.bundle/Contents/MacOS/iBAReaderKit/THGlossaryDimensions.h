...
@interface THGlossaryDimensions : NSObject
+(CGSize)glossaryAlphaTabsCellSize;
+(id)termsBackgroundColor;
+(id)definitionsViewBackgroundColor;
+(id)termTableBackgroundHighlightColor;
+(id)definitionScrollViewBackgroundColor;
+(id)termTableTextHighlightColor;
