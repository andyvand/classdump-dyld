...
@interface BKPaginatedPageLayoutController : BKReflowablePageLayoutController <BKReflowableLiveResizeHandlerDelegate, BKPlatformScrollSwipingControllerDelegate> {
...
-(char)p_shouldUseTwoPageSpreadWithMarginNotes:(char)arg1 ;
