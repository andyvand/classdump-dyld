...
@interface BKSeriesAsset : NSObject <BKAsset> {
...
@property (retain) NSNumber * seriesIsHidden;                            //@synthesize seriesIsHidden=_seriesIsHidden - In the implementation block
@property (retain) NSNumber * seriesIsCloudOnly;                         //@synthesize seriesIsCloudOnly=_seriesIsCloudOnly - In the implementation block
...
@property (retain) NSNumber * seriesSortKey;                             //@synthesize seriesSortKey=_seriesSortKey - In the implementation block
...
-(id)initWithSeriesInfo:(id)arg1 ;
-(void)setSeriesID:(NSString *)arg1 ;
-(void)setScrollDirection:(NSString *)arg1 ;
-(void)setSequenceDisplayName:(NSString *)arg1 ;
-(void)setSeriesIsHidden:(NSNumber *)arg1 ;
-(void)setSeriesSortKey:(NSNumber *)arg1 ;
-(void)setSeriesIsCloudOnly:(NSNumber *)arg1 ;
-(NSString *)genre;
