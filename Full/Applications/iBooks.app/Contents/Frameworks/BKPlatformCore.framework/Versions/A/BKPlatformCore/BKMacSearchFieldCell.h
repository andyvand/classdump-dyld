...
@property (assign,getter=isMagnifyingGlassHidden,nonatomic) char magnifyingGlassHidden; 
...
-(char)isMagnifyingGlassHidden;
-(void)setMagnifyingGlassHidden:(char)arg1 ;
