...
+(int)keychainRefToSSID:(OpaqueSecKeychainRefRef)arg1 ssid:(unsigned*)arg2 ;
+(id)bundleNameForSubservice:(unsigned)arg1 ;
-(void)showInfoWindowForKeychain:(OpaqueSecKeychainRefRef)arg1 ;
-(id)init;
-(void)dealloc;
@end
