...
@class AUInternetModel, NSPopUpButton, NSTextField, NSView, NSBox, NSTabView, NSButton, NSUndoManager, NSString;
...
@property (assign,nonatomic) id<AUSettingsViewControllerDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
@property (nonatomic,retain) AUInternetModel * dataModel; 
@property (nonatomic,retain) NSUndoManager * undoManager; 
@property (nonatomic,retain) NSView * advancedPPPoEView; 
@property (nonatomic,retain) NSView * advancedIPv6TunnelRemoteEndView; 
...
-(void)setAdvancedPPPoEView:(NSView *)arg1 ;
-(void)setAdvancedIPv6TunnelRemoteEndView:(NSView *)arg1 ;
...
-(CGSize)resizeAdvancedOptionsContent;
...
-(NSView *)advancedPPPoEView;
-(NSView *)advancedIPv6TunnelRemoteEndView;
-(void)setDelegate:(id<AUSettingsViewControllerDelegate>)arg1 ;
-(void)dealloc;
-(void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void*)arg4 ;
-(NSString *)title;
-(id<AUSettingsViewControllerDelegate>)delegate;
-(NSUndoManager *)undoManager;
