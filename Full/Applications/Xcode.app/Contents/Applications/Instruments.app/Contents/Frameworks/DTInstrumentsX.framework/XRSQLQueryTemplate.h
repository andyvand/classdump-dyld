...
-(id)initWithPreparedStatement:(sqlite3_stmtRef)arg1 ;
-(void)executeWithBindings:(NSMutableArray*)arg1 enumerateResultsWith:(/*^block*/id)arg2 ;
-(void)bindExtraVariables:(sqlite3_stmtRef)arg1 ;
-(id)computeExtrasForRow:(sqlite3_stmtRef)arg1 ;
-(void)dealloc;
@end
