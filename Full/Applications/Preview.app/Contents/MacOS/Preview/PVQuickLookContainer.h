...
@class QLPreviewDocument, QLPreviewView, NSString, NSMutableArray;

@interface PVQuickLookContainer : PVMediaContainerBase {

	QLPreviewDocument* _quickLookDocument;
	QLPreviewView* _quickLookView;
	char _observingIsLoaded;
	NSString* _password;
	NSMutableArray* _elements;

}

@property (readonly) QLPreviewDocument * quickLookDocument;              //@synthesize quickLookDocument=_quickLookDocument - In the implementation block
@property (readonly) QLPreviewView * quickLookView;                      //@synthesize quickLookView=_quickLookView - In the implementation block
...
-(QLPreviewDocument *)quickLookDocument;
