...
#import <DevMateFeedback/DMReportManagerDelegate.h>
#import <DevMateFeedback/NSTextViewDelegate.h>

@protocol DMControllerRestartDelegate;
@class NSDictionary, NSImageView, NSTextField, NSTextView, NSButton, NSProgressIndicator, DMReportManager_FEEDBACK, DMInfoPopoverViewController_FEEDBACK, DMFeedbackContainerView_FEEDBACK, NSArray;

@interface DMFeedbackReportWindowController : NSWindowController <DMReportManagerDelegate, NSTextViewDelegate> {
	...
	DMReportManager_FEEDBACK* _reportsSender;
	DMInfoPopoverViewController_FEEDBACK* _infoPopoverController;
	DMFeedbackContainerView_FEEDBACK* _commentContainer;
...
@property (nonatomic,retain) DMReportManager_FEEDBACK * reportsSender;                                  //@synthesize reportsSender=_reportsSender - In the implementation block
@property (nonatomic,retain) DMInfoPopoverViewController_FEEDBACK * infoPopoverController;              //@synthesize infoPopoverController=_infoPopoverController - In the implementation block
@property (assign,nonatomic) DMFeedbackContainerView_FEEDBACK * commentContainer;                       //@synthesize commentContainer=_commentContainer - In the implementation block
...
-(DMFeedbackContainerView_FEEDBACK *)commentContainer;
...
-(id)reportsToSend;
-(void)setInfoPopoverController:(DMInfoPopoverViewController_FEEDBACK *)arg1 ;
-(void)setReportsSender:(DMReportManager_FEEDBACK *)arg1 ;
-(void)cancelReporting:(id)arg1 ;
-(NSButton *)attachmentButton;
-(void)com_devmate_windowWillClose:(id)arg1 ;
-(DMReportManager_FEEDBACK *)reportsSender;
-(NSDictionary *)defaultUserInfo;
-(void)switchUIToSendingMode:(char)arg1 ;
-(void)showGratitudeAlert;
-(id)attachmentCommentView;
-(DMInfoPopoverViewController_FEEDBACK *)infoPopoverController;
...
-(void)setCommentContainer:(DMFeedbackContainerView_FEEDBACK *)arg1 ;
