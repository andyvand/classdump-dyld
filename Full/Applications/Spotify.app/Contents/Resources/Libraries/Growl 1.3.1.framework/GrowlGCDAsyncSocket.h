...
+(id)hostFromAddress4:(sockaddr_in*)arg1 ;
+(id)hostFromAddress6:(sockaddr_in6*)arg1 ;
+(unsigned short)portFromAddress4:(sockaddr_in*)arg1 ;
+(unsigned short)portFromAddress6:(sockaddr_in6*)arg1 ;
