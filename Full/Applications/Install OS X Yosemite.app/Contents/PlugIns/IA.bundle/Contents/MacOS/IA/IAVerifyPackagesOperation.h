...
@interface IAVerifyPackagesOperation : IASetupOperation
-(void)startWithDelegate:(id)arg1 ;
-(char)_areDownloadedPackagesTrustedReturningError:(id*)arg1 ;
-(char)_isTrustedPackageAtURL:(id)arg1 error:(id*)arg2 ;
@end
