...
@class NSURL, IA_PKProductInfo, NSData, PKDistributionContainer, PKDistribution, NSString;

@interface IA_PKNetEnabledProduct : IA_PKMutableProduct {

	NSURL* _url;
	IA_PKProductInfo* _productInfo;
