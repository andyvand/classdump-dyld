...
@class NSUUID, NSString, NSDictionary, NSError, FMDRequestRetryHelper, NSURL, NSMutableDictionary;
...
@property (nonatomic,readonly) char needsSignature; 
@property (nonatomic,readonly) char showAuthFailedMessage; 
...
@property (assign,nonatomic) char willRetry;                                                    //@synthesize willRetry=_willRetry - In the implementation block
...
@property (nonatomic,readonly) char canRequestBeRetriedNow; 
...
-(id)completeBody;
-(id)completeRequestHeadersForBody:(id)arg1 ;
...
-(void)setWillRetry:(char)arg1 ;
-(id)_basicAuthValue;
-(char)needsSignature;
-(char)showAuthFailedMessage;
