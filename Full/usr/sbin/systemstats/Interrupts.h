...
@interface Interrupts : PBCodable {
...
@property (nonatomic,retain) NSMutableArray * vectors;                     //@synthesize vectors=_vectors - In the implementation block
-(unsigned long long)absoluteTime;
-(void)setAbsoluteTime:(unsigned long long)arg1 ;
-(NSMutableArray *)vectors;
-(void)setVectors:(NSMutableArray *)arg1 ;
-(void)addVectors:(id)arg1 ;
-(unsigned long long)vectorsCount;
-(void)clearVectors;
-(id)vectorsAtIndex:(unsigned long long)arg1 ;
