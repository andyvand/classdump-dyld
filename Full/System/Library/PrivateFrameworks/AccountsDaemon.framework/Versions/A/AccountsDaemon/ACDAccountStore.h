...
@class NSMutableArray, ACDDatabase, ACDClientAuthorizationManager, ACDFakeRemoteAccountStoreSession, ACDClient, ACDAccountStoreFilter, ACDAuthenticationPluginManager, ACDAccessPluginManager, ACDDataclassOwnersManager, ACDAuthenticationDialogManager, ACIDSProxy, NSString;
...
@property (__weak) ACDAccountStoreFilter * filter;                                            //@synthesize filter=_filter - In the implementation block
...
@property (retain) ACIDSProxy * acIDSProxy;                                                   //@synthesize acIDSProxy=_acIDSProxy - In the implementation block
