...
+(id)openSearchNode;
-(id)findRecordsByID:(long long)arg1 type:(SCD_Struct_Us2*)arg2 attribute:(SCD_Struct_DS8*)arg3 ;
...
-(id)findRecordByID:(long long)arg1 type:(SCD_Struct_Us2*)arg2 attribute:(SCD_Struct_DS8*)arg3 ;
...
-(id)_recordsFromBuffer:(SCD_Struct_DS8*)arg1 count:(unsigned)arg2 ;
...
-(id)_findUsersWithFullName:(SCD_Struct_DS8*)arg1 attribute:(SCD_Struct_Us2*)arg2 expectedCount:(unsigned)arg3 ;
...
-(id)_findRecordsByID:(long long)arg1 type:(SCD_Struct_Us2*)arg2 attribute:(SCD_Struct_DS8*)arg3 expectedCount:(unsigned)arg4 ;
...
-(id)findUsersWithFullName:(SCD_Struct_DS8*)arg1 attribute:(SCD_Struct_Us2*)arg2 ;
-(id)findUserWithFullName:(SCD_Struct_DS8*)arg1 attribute:(SCD_Struct_Us2*)arg2 ;
-(id)directoryService;
-(void)deauthenticate;
-(id)nodeName;
-(void)finalize;
