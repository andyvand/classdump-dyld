...
@property (assign,nonatomic) int MeetingRequestType;                               //@synthesize MeetingRequestType=_MeetingRequestType - In the implementation block
@property (assign,nonatomic) int IntendedFreeBusyStatus;                           //@synthesize IntendedFreeBusyStatus=_IntendedFreeBusyStatus - In the implementation block
...
-(void)setMeetingRequestType:(int)arg1 ;
-(int)IntendedFreeBusyStatus;
-(void)setIntendedFreeBusyStatus:(int)arg1 ;
