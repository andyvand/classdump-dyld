...
-(void)incorporateDataFromCSSymbolOwner:(CSTypeRef)arg1 andPath:(const char*)arg2 ;
-(id)initWithCSSymbolOwnerRef:(CSTypeRef)arg1 andPath:(const char*)arg2 ;
...
-(id)_initWithSerializedSymbolOwner:(const SCD_Struct_PA14*)arg1 ;
