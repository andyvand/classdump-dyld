...
-(void)generationsCopy:(id)arg1 toPath:(id)arg2 forGenerations:(id)arg3 withOptions:(unsigned long long)arg4 reply:(/*^block*/id)arg5;
-(void)archiveCreate:(id)arg1 forGenerations:(id)arg2 withTransferOptions:(unsigned long long)arg3 reply:(/*^block*/id)arg4;
-(oneway void)archiveDestroy:(id)arg1 forPath:(id)arg2;
-(void)archiveImport:(id)arg1 forPath:(id)arg2 withTransferOptions:(unsigned long long)arg3 reply:(/*^block*/id)arg4;
