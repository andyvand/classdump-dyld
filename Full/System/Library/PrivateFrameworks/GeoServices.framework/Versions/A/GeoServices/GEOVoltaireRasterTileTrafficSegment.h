...
@property (nonatomic,readonly) SCD_Struct_GE77* vertices;              //@synthesize vertices=_vertices - In the implementation block
...
-(SCD_Struct_GE77*)vertices;
-(void)setHasSpeed:(char)arg1 ;
-(char)hasSpeed;
-(void)setVertices:(SCD_Struct_GE77*)arg1 count:(long long)arg2 ;
