...
@interface GEOSuggestionEntry : PBCodable <NSCopying> {
	...
	SCD_Struct_GE217* _textHighlights;
...
@property (nonatomic,readonly) SCD_Struct_GE217* textHighlights; 
...
-(SCD_Struct_GE217*)textHighlights;
...
-(SCD_Struct_GE217)textHighlightsAtIndex:(unsigned long long)arg1 ;
-(void)addTextHighlights:(SCD_Struct_GE217)arg1 ;
-(void)setTextHighlights:(SCD_Struct_GE217*)arg1 count:(unsigned long long)arg2 ;
-(char)hasIconID;
-(NSString *)iconID;
-(void)dealloc;
-(id)description;
