...
@interface GEOCarInfo : PBCodable <NSCopying> {
	...
	SCD_Struct_GE218 _screenResolution;
...
@property (assign,nonatomic) SCD_Struct_GE219 screenResolution;              //@synthesize screenResolution=_screenResolution - In the implementation block
...
-(void)setScreenResolution:(SCD_Struct_GE219)arg1 ;
...
-(SCD_Struct_GE219)screenResolution;
-(void)dealloc;
-(id)description;
