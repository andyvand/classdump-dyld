...
@interface GEOStep : PBCodable <NSCopying> {
	...
	SCD_Struct_GE66* _junctionElements;
...
@property (nonatomic,readonly) SCD_Struct_GE66* junctionElements; 
...
-(SCD_Struct_GE66)junctionElementAtIndex:(unsigned long long)arg1 ;
-(void)addJunctionElement:(SCD_Struct_GE66)arg1 ;
...
-(SCD_Struct_GE66*)junctionElements;
-(void)setJunctionElements:(SCD_Struct_GE66*)arg1 count:(unsigned long long)arg2 ;
