...
-(char)_pointConnects:(const Matrix<float, 2, 1>*)arg1 rect:(const SCD_Struct_GE54*)arg2 to:(const SCD_Struct_GE15*)arg3 ;
-(char)_edgeStart:(const Matrix<float, 2, 1>*)arg1 end:(const Matrix<float, 2, 1>*)arg2 connectsTo:(const SCD_Struct_GE15*)arg3 rect:(const SCD_Struct_GE54*)arg4 ;
-(id)edgeHandler;
-(void)dealloc;
-(void)cancel;
@end
