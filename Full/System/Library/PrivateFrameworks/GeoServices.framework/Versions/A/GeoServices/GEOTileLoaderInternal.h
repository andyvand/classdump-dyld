...
@class GEOTilePool, NSMutableSet, GEOTileServerProxy, NSMutableArray, GEOTileLoaderConfiguration, NSString;
...
@interface GEOTileLoaderInternal : GEOTileLoader <GEOTileServerProxyDelegate, GEOResourceManifestTileGroupObserver> {
	...
	dispatch_queue_sRef _internalDelegateQ;
...
-(void)loadKey:(const GEOTileKey*)arg1 priority:(unsigned)arg2 forClient:(id)arg3 options:(unsigned long long)arg4 callbackQ:(dispatch_queue_sRef)arg5 beginNetwork:(/*^block*/id)arg6 callback:(/*^block*/id)arg7 ;
...
-(int)diskHits;
-(int)networkHits;
-(void)calculateFreeableSizeWithCallbackQ:(dispatch_queue_sRef)arg1 finished:(/*^block*/id)arg2 ;
-(void)shrinkDiskCacheToSize:(unsigned long long)arg1 callbackQ:(dispatch_queue_sRef)arg2 finished:(/*^block*/id)arg3 ;
-(void)setInternalDelegate:(id)arg1 ;
-(id)internalDelegate;
-(void)setInternalDelegateQ:(dispatch_queue_sRef)arg1 ;
-(dispatch_queue_sRef)internalDelegateQ;
...
-(void)loadKey:(const GEOTileKey*)arg1 priority:(unsigned)arg2 forClient:(id)arg3 proxyClient:(id)arg4 options:(unsigned long long)arg5 callbackQ:(dispatch_queue_sRef)arg6 beginNetwork:(/*^block*/id)arg7 callback:(/*^block*/id)arg8 ;
