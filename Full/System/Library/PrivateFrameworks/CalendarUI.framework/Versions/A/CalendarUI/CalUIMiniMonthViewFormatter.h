...
@interface CalUIMiniMonthViewFormatter : NSObject {
	...
	char _weekNumberSeparatorTopInset;
	char _weekNumberSeparatorBottomInset;
...
@property (assign) unsigned long long monthNameTextAlignment;                      //@synthesize monthNameTextAlignment=_monthNameTextAlignment - In the implementation block
...
@property (assign) unsigned long long weekdayTextAlignment;                        //@synthesize weekdayTextAlignment=_weekdayTextAlignment - In the implementation block
...
@property (assign) unsigned long long dayNumberTextAlignment;                      //@synthesize dayNumberTextAlignment=_dayNumberTextAlignment - In the implementation block
...
@property (assign) unsigned long long weekNumbersHorizontalAlignment;              //@synthesize weekNumbersHorizontalAlignment=_weekNumbersHorizontalAlignment - In the implementation block
...
@property (assign) char weekNumberSeparatorTopInset;                               //@synthesize weekNumberSeparatorTopInset=_weekNumberSeparatorTopInset - In the implementation block
@property (assign) char weekNumberSeparatorBottomInset;                            //@synthesize weekNumberSeparatorBottomInset=_weekNumberSeparatorBottomInset - In the implementation block
...
-(void)setMonthNameTextAlignment:(unsigned long long)arg1 ;
...
-(void)setWeekdayTextAlignment:(unsigned long long)arg1 ;
...
-(void)setDayNumberTextAlignment:(unsigned long long)arg1 ;
...
-(void)setWeekNumbersHorizontalAlignment:(unsigned long long)arg1 ;
...
-(unsigned long long)monthNameTextAlignment;
...
-(unsigned long long)weekdayTextAlignment;
...
-(unsigned long long)dayNumberTextAlignment;
...
-(unsigned long long)weekNumbersHorizontalAlignment;
-(double)weekNumbersXOffset;
-(double)weekNumbersYOffset;
-(char)drawWeekNumbersSeparator;
-(NSColor *)weekNumberSeparatorColor;
-(char)weekNumberSeparatorTopInset;
-(void)setWeekNumberSeparatorTopInset:(char)arg1 ;
-(char)weekNumberSeparatorBottomInset;
-(void)setWeekNumberSeparatorBottomInset:(char)arg1 ;
