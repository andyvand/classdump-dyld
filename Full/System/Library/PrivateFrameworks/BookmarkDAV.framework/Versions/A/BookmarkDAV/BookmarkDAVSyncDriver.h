...
-(char)_addChange:(void*)arg1 toData:(id)arg2 numActionsP:(int*)arg3 runningSizeP:(int*)arg4 maxResources:(long long)arg5 maxSize:(long long)arg6 foldersToAddByServerId:(CFDictionaryRef)arg7 parentToArrayOfChildrenFolderChanges:(CFDictionaryRef)arg8 pushedParentToArrayOfChildrenFolders:(CFDictionaryRef)arg9 ;
