...
@class AirPortNetworkPrefs, AirPortOptionsTabViewItem;

@interface ANPAdvancedViewAirPort : ANPAdvancedView {

	AirPortNetworkPrefs* mAPNetworkPrefs;
	AirPortOptionsTabViewItem* mAirPortTabViewItem;
