...
@class NSView, ANPSimpleViewStatus, NSArray, ANPService, NSTabViewItem;

@interface ANPSimpleView : NSObject {

	NSView* o_view;
	ANPSimpleViewStatus* o_statusView;
...
-(void)addStatusViewBelow:(id)arg1 ;
-(char)shouldSimpleControlsBeEnabled;
