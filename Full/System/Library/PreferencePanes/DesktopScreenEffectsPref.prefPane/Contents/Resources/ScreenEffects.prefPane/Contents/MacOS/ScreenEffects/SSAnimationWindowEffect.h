...
#import <ScreenEffects/NSAnimationDelegate.h>

@class ScreenSaverWindowAnimation, NSArray, NSString;

@interface SSAnimationWindowEffect : ScreenSaverWindowEffect <NSAnimationDelegate> {

	unsigned _windowID;
	unsigned _cid;
	ScreenSaverWindowAnimation* _animation;
	NSArray* _subEffects;
	char _mainEffect;
	char _inverted;
...
@property (retain) ScreenSaverWindowAnimation * animation; 
@property (readonly) unsigned long long hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
-(void)setAnimation:(ScreenSaverWindowAnimation *)arg1 ;
-(void)abort;
...
-(ScreenSaverWindowAnimation *)animation;
