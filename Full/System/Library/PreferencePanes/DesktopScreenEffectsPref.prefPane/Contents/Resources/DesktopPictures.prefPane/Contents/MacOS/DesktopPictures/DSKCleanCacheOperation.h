...
@interface DSKCleanCacheOperation : DSKApplyDesktopConfigOperation
-(void)_mainWithFileManager:(id)arg1 ;
-(char)_removeAll:(id)arg1 but:(id)arg2 fileManager:(id)arg3 ;
-(void)main;
@end
