...
@interface ABExchangeDateUtils : NSObject
+(id)exchangeDateComponentsFromAddressBookDate:(id)arg1 ;
+(id)exchangeDateComponentsFromAddressBookDate:(id)arg1 localTimeZone:(id)arg2 ;
@end
