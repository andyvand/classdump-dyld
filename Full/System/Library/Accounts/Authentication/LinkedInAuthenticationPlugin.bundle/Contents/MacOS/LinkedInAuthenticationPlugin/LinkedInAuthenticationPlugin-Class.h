...
* Image Source: /System/Library/Accounts/Authentication/LinkedInAuthenticationPlugin.bundle/Contents/MacOS/LinkedInAuthenticationPlugin
* classdump-dyld is licensed under GPLv3, Copyright © 2013 by Elias Limneos.
*/

#import <LinkedInAuthenticationPlugin/ACDAccountAuthenticationPlugin.h>

@class NSString;

@interface LinkedInAuthenticationPlugin : NSObject <ACDAccountAuthenticationPlugin>
...
-(void)_displayBadCredentialsAlertForAccount:(id)arg1 clientName:(id)arg2 reason:(id)arg3 handler:(/*^block*/id)arg4 ;
-(id)_consumerKey;
-(id)linkedinIconURL;
-(id)_consumerSecret;
-(id)_udid;
-(id)_stringFromResponseObject:(id)arg1 ;
