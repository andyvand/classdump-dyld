...
@class PFUbiquityLocation, NSString, NSURL, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSDictionary;
...
+(void)startDownloadForItems:(id)arg1 onQueue:(dispatch_queue_sRef)arg2 withBlock:(/*^block*/id)arg3 ;
+(id)sharedPrivateOperationQueue;
+(id)cloudDocsRootFolder;
+(void)registerInitialSyncHandlerForURL:(id)arg1 andContainerID:(id)arg2 onQueue:(dispatch_queue_sRef)arg3 withBlock:(/*^block*/id)arg4 ;
+(void)initialize;
...
-(id)initWithUbiquityRootLocation:(id)arg1 localPeerID:(id)arg2 storeName:(id)arg3 processingQueue:(dispatch_queue_sRef)arg4 ;
