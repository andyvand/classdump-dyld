...
@class QFilterCellDomainsApplications, QFilterCellDomainsPDFWorkflows, QFilterCellDomainsPrinting;

@interface QFilterComponentDomains : QFilterComponent {

	QFilterCellDomainsApplications* applDomainCell;
	QFilterCellDomainsPDFWorkflows* pdfwDomainCell;
	QFilterCellDomainsPrinting* printDomainCell;
