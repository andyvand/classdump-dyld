...
@property (assign) char singleSelection;                               //@synthesize singleSelection=_singleSelection - In the implementation block
...
@property (assign) long long resolution;                               //@synthesize resolution=_resolution - In the implementation block
