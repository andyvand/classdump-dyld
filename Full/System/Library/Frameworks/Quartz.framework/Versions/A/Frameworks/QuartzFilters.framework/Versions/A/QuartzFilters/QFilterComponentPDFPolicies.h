...
@class QFilterCellPDFImageInterpolation, QFilterCellPDFSeparations;

@interface QFilterComponentPDFPolicies : QFilterComponent {

	QFilterCellPDFImageInterpolation* pdfinterpCell;
	QFilterCellPDFSeparations* pdfseparationCell;
