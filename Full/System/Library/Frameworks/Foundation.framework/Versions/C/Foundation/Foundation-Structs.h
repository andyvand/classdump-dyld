...
typedef union {
	SCD_Struct_NS50 _singleRange;
	SCD_Struct_NS49 _multipleRanges;
} SCD_Union_NS51;
...
typedef struct {
	double field1;
	SCD_Struct_NS8 field2;
	1 field3;
} SCD_Struct_NS87;

typedef struct {
	SCD_Struct_NS8 field1;
	1 field2;
	SCD_Struct_NS8 field3;
	1 field4;
} SCD_Struct_NS88;
...
typedef union {
	SCD_Struct_NS97 extern_data;
	SCD_Struct_NS96 inline_slab;
