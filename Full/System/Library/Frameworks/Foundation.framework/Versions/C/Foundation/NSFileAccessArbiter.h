...
@class NSMutableDictionary, NSFileAccessNode, NSString;
...
@interface NSFileAccessArbiter : NSObject <NSFileAccessArbiter> {
	...
	xpc_connection_sRef _superarbitrationServer;
...
-(void)writerWithPurposeID:(id)arg1 didMakeItemDisappearAtURL:(id)arg2 ;
-(void)writerWithPurposeID:(id)arg1 didChangeItemAtURL:(id)arg2 ;
-(id)initWithQueue:(dispatch_queue_sRef)arg1 isSubarbiter:(char)arg2 listener:(xpc_connection_sRef)arg3 ;
...
-(void)writerWithPurposeID:(id)arg1 didReconnectItemAtURL:(id)arg2 ;
-(void)writerWithPurposeID:(id)arg1 didVersionChangeOfKind:(id)arg2 toItemAtURL:(id)arg3 withClientID:(id)arg4 name:(id)arg5 ;
-(void)_handleMessage:(void*)arg1 fromClient:(xpc_connection_sRef)arg2 ;
-(void)_handleCanceledClient:(xpc_connection_sRef)arg1 ;
-(void)_registerForDebugInfoRequests;
-(void)_handleMessage:(void*)arg1 forSubarbitrationClaim:(id)arg2 server:(xpc_connection_sRef)arg3 ;
...
-(void)_grantSubarbitrationClaim:(id)arg1 withServer:(xpc_connection_sRef)arg2 ;
...
-(char)_handleMessage:(void*)arg1 ofKind:(id)arg2 withParameters:(id)arg3 embeddedServer:(xpc_connection_sRef)arg4 fromClient:(xpc_connection_sRef)arg5 ;
...
-(void)_startArbitratingItemsAtURLs:(id)arg1 withSuperarbitrationServer:(xpc_connection_sRef)arg2 ;
