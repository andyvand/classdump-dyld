...
+(char)_fromContainerInfo:(const SCD_Struct_NS52*)arg1 andKeyCode:(unsigned)arg2 getAdjustedContainerInfo:(SCD_Struct_NS52*)arg3 andKey:(id*)arg4 ;
+(char)_fromRecord:(id)arg1 getContainerInfo:(SCD_Struct_NS52*)arg2 andKey:(id*)arg3 ;
+(unsigned)_keyCodeFromRecord:(id)arg1 ;
+(char)_fromRecord:(id)arg1 getContainerInfo:(SCD_Struct_NS52*)arg2 ;
