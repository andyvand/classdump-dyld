...
-(id)_initWithProperties:(const SCD_Struct_NS70*)arg1 primitiveType:(id)arg2 ;
...
-(id)_initWithProperties:(const SCD_Struct_NS70*)arg1 defaultSubcontainerAttributeKey:(id)arg2 inverseRelationshipKeys:(id)arg3 ;
