...
-(id)_initWithProperties:(const SCD_Struct_NS71*)arg1 ;
-(void)_setAccessGroups:(id)arg1 ;
-(id)_initWithProperties:(const SCD_Struct_NS71*)arg1 commandName:(id)arg2 resultTypeAppleEventCode:(unsigned)arg3 ;
