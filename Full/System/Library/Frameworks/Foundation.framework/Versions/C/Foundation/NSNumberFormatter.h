...
-(void)__oldnf_addThousandSeparators:(id)arg1 withBuffer:(SCD_Struct_NS66*)arg2 ;
-(void)__oldnf_surroundValueInString:(unsigned short*)arg1 withLength:(long long*)arg2 andBuffer:(SCD_Struct_NS66*)arg3 ;
-(char)__oldnf_decimalIsNotANumber:(id)arg1 ;
-(id)__oldnf_addThousandSeparatorsToFormat:(id)arg1 withBuffer:(SCD_Struct_NS66*)arg2 ;
-(id)__oldnf_numberStringForValueObject:(id)arg1 withBuffer:(SCD_Struct_NS66*)arg2 andNegativeFlag:(char)arg3 ;
-(id)init;
-(void)finalize;
-(void)dealloc;
