...
+(id)isd_rootProxyForConnectionWithRegisteredName:(id)arg1 requestTimeout:(double)arg2 replyTimeout:(double)arg3 protocol:(id)arg4 enableMultipleThreads:(char)arg5 independentConversations:(char)arg6 ;
+(id)statistics;
