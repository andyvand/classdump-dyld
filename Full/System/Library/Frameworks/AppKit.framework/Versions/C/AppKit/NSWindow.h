...
* on Sunday, February 15, 2015 at 1:32:16 PM Central European Standard Time
...
-(void)constrainToScreen:(id)arg1 adjustWidth:(char)arg2 adjustHeight:(char)arg3 ;
...
-(CGRect)SCTConvertBaseToScreenRect:(CGRect)arg1 ;
