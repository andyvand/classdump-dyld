...
@property (retain,readonly) NSArray * regularActions; 
@property (retain,readonly) NSArray * conversionActions; 
@property (retain) AMApplicationDefinition * applicationDefinitionAsActionFilter;                //@synthesize applicationDefinitionAsActionFilter=_applicationDefinitionAsActionFilter - In the implementation block
@property (assign) char shouldFilterActions; 
@property (readonly) char isFilteringActions; 
