...
@interface ABSleepServicesLiaison : NSObject

@property (readonly) NSString * sleepWakeUUID; 
@property (readonly) NSString * sleepServicesUUID; 
-(id)readUUID:(int)arg1 ;
-(NSString *)sleepWakeUUID;
-(NSString *)sleepServicesUUID;
@end
