...
@class NSMutableOrderedSet, NSMapTable, NSMutableArray, NSArray;
...
-(SCD_Struct_MK4)_mapRectWithFractionOfVisible:(double)arg1 ;
-(void)_removeDrawable:(id)arg1 forOverlay:(id)arg2 level:(long long)arg3 ;
-(id)_considerAddingDrawable:(id)arg1 inAddRect:(SCD_Struct_MK4)arg2 level:(long long)arg3 ;
