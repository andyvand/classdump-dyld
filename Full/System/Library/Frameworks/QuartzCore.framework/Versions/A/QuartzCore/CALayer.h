...
#import <QuartzCore/QLDisplayable.h>

@class NSView, NSResponder, NSDictionary, NSString, NSArray, CAMeshTransform;

@interface CALayer : NSObject <CAPropertyInfo, NSCoding, CAMediaTiming, QLDisplayable> {

	CALayerIvars* _attr;

}

@property (assign) char usesPanoramicStretch; 
@property (assign) CGSize naturalSizeForPanoramicStretch; 
@property (setter=_setUsesPanoramicStretch:,getter=_usesPanoramicStretch) char _usesPanoramicStretch; 
...
@property (setter=NS_setContentsScaleSize:,getter=NS_actualContentsScaleSize) CGSize NS_contentsScaleSize; 
@property (getter=NS_contentsScaleSize,readonly) CGSize NS_contentsScaleSizeOrContentsScale; 
@property (readonly) char NS_contentsAligningEnabled; 
@property (readonly) char NS_shouldUseContentsAligning; 
@property (readonly) CGRect NS_visibleRect; 
@property (readonly) double NS_suggestedContentsScale; 
@property (readonly) CGSize NS_suggestedContentsScaleSize; 
@property (setter=NS_setDefersTransformInvalidation:,getter=NS_defersTransformInvalidation) char NS_defersTransformInvalidation; 
@property (setter=NS_setView:,getter=NS_view) NSView * NS_view; 
...
+(char)automaticallyNotifiesObserversOfUsesPanoramicStretch;
...
-(void)safari_setAnchorPointPreservingFrame:(CGPoint)arg1 ;
-(void)safari_applyIconTreatmentWithCornerRadius:(double)arg1 ;
-(void)safari_applyIconTreatment;
-(void)setUsesPanoramicStretch:(char)arg1 ;
-(char)usesPanoramicStretch;
...
-(void)setAnchorPointWithoutShift:(CGPoint)arg1 ;
...
-(id)knobLayer;
-(void)setup:(id)arg1 ;
-(void)_ql_getPixelBufferPixelFormat:(unsigned*)arg1 ;
-(char)_ql_renderIntoPixelBuffer:(CVBufferRef)arg1 forTime:(SCD_Struct_CA19*)arg2 ;
...
-(CGSize)NS_contentsScaleSize;
-(CGRect)NS_displayRect;
-(CGRect)NS_alignedDisplayRect;
-(CGRect)NS_convertRectFromDisplay:(CGRect)arg1 ;
-(void)NS_updateOpaqueForContentsAligning;
-(void)NS_updateContentsTransformForContentsAligning;
-(double)NS_displayContentsScale;
-(CGRect)NS_convertRectToDisplay:(CGRect)arg1 ;
-(CGRect)NS_displayAlignedRect:(CGRect)arg1 options:(unsigned long long)arg2 ;
-(CGRect)NS_alignedRect;
-(void)NS_prepareForDisplayUsingContentsAligning;
-(char)NS_shouldUseContentsAligning;
-(CGRect)NS_displayAlignedRect:(CGRect)arg1 ;
-(void)NS_setNeedsDisplayInRectUsingContentsAligning:(CGRect)arg1 ;
...
-(char)NS_shouldChangeFontSmoothing;
...
-(CGContextRef)NS_focusContext;
-(void)NS_didChangeDefaultContentsScale:(double)arg1 ;
-(CGSize)NS_suggestedContentsScaleSize;
