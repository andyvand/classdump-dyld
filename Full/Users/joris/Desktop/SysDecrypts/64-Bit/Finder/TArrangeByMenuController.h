...
@class NSMenu, NSMenuItem, TViewOptionsSettingsController, TNodeViewSettings, NSString;
...
@property (assign,nonatomic) TViewOptionsSettingsController * viewOptionsSettingsController;              //@synthesize viewOptionsSettingsController=_viewOptionsSettingsController - In the implementation block
@property (nonatomic,retain) TNodeViewSettings * viewSettings;                                            //@synthesize viewSettings=_viewSettings - In the implementation block
