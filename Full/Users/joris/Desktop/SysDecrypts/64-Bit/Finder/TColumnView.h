...
@property (nonatomic,readonly) TColumnViewController * controller;              //@synthesize controller=_controller - In the implementation block
...
-(TColumnViewController *)controller;
