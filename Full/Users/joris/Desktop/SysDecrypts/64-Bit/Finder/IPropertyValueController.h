...
@class NSObject, TLayoutBinder, IPropertyValueExtractor;
...
@property (nonatomic,retain) IPropertyValueExtractor * valueExtractor;              //@synthesize valueExtractor=_valueExtractor - In the implementation block
...
-(void)setValueExtractor:(IPropertyValueExtractor *)arg1 ;
...
-(IPropertyValueExtractor *)valueExtractor;
