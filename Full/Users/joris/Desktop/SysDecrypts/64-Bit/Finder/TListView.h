...
@class TListViewController, TTableViewShrinkToFitController, NSString;

@interface TListView : NSOutlineView <NSMenuDelegate> {
	...
	TNSRef<TLayer *> _headerDropShadowLayer;
