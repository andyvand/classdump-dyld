...
@class TListTableColumn, NSDateFormatter, NSMutableDictionary, NSString, TListMoreCell, TListNameField, NSMutableArray, TListHeaderRowView;
...
@property (assign,nonatomic) TListTableColumn * genericTextColumn;                      //@synthesize genericTextColumn=_genericTextColumn - In the implementation block
@property (assign,nonatomic) TListTableColumn * genericDateColumn;                      //@synthesize genericDateColumn=_genericDateColumn - In the implementation block
@property (assign,nonatomic) TListTableColumn * genericNumericColumn;                   //@synthesize genericNumericColumn=_genericNumericColumn - In the implementation block
...
@property (nonatomic,retain) TListNameField * originalEditedNameField;                  //@synthesize originalEditedNameField=_originalEditedNameField - In the implementation block
@property (assign,nonatomic) double floatingHeaderY;                                    //@synthesize floatingHeaderY=_floatingHeaderY - In the implementation block
@property (nonatomic,retain) TListHeaderRowView * headerRowView;                        //@synthesize headerRowView=_headerRowView - In the implementation block
...
-(void)setHeaderRowView:(TListHeaderRowView *)arg1 ;
...
-(TListTableColumn *)genericTextColumn;
-(void)setGenericTextColumn:(TListTableColumn *)arg1 ;
-(TListTableColumn *)genericDateColumn;
-(void)setGenericDateColumn:(TListTableColumn *)arg1 ;
-(TListTableColumn *)genericNumericColumn;
-(void)setGenericNumericColumn:(TListTableColumn *)arg1 ;
...
-(TListNameField *)originalEditedNameField;
-(void)setOriginalEditedNameField:(TListNameField *)arg1 ;
