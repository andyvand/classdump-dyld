...
@class TShrinkToFitController, NSWindow;

@interface TShrinkToFitTextView : TTextView {

	TNSRef<TShrinkToFitWindow *> _stfWindow;
...
@property (assign,nonatomic) TShrinkToFitController * controller;              //@synthesize controller=_controller - In the implementation block
...
-(TShrinkToFitController *)controller;
-(void)setFont:(id)arg1 ;
-(NSWindow *)parentWindow;
-(void)doCommandBySelector:(SEL)arg1 ;
-(BOOL)isEditing;
-(void)setController:(TShrinkToFitController *)arg1 ;
