...
#import <Finder/NSBrowserDelegate.h>
#import <Finder/NSMenuDelegate.h>
#import <Finder/AccessibilityProtocol.h>
#import <Finder/TNameTextFieldDelegate.h>
#import <Finder/TDuplicateTaskDelegateProtocol.h>

@class NSTimer, TColumnPreviewController, NSString;
...
@interface TColumnViewController : TBrowserViewController <FIAliasResolution, NSBrowserDelegate, NSMenuDelegate, AccessibilityProtocol, TNameTextFieldDelegate, TDuplicateTaskDelegateProtocol> {
	...
	TNSRef<TColumnPreviewController *> _previewViewController;
	double _textSize;
	BOOL _showIcons;
...
@property (nonatomic,retain,readonly) TColumnPreviewController * previewViewController; 
...
-(TColumnPreviewController *)previewViewController;
-(id)nibName;
