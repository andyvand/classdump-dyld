...
+(void)addViewSpecificStuffToMenu:(id)arg1 clickedView:(id)arg2 browserViewController:(id)arg3 context:(unsigned)arg4 ;
...
-(void)configureForPathbarWithNode:(const TFENode*)arg1 browserViewController:(id)arg2 clickedView:(id)arg3 ;
-(void)configureForSidebarWithNode:(const TFENode*)arg1 browserViewController:(id)arg2 clickedView:(id)arg3 constrained:(BOOL)arg4 data:(id)arg5 ;
-(void)configureForTabViewWithNode:(const TFENode*)arg1 browserViewController:(id)arg2 clickedView:(id)arg3 ;
