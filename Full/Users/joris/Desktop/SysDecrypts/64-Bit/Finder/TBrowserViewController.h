...
@class TBrowserContainerController, TViewOptionsSettingsController, NSView, NSCountedSet, TBrowserViewDataSource, NSString;
...
@interface TBrowserViewController : TBaseBrowserViewController <TThumbnailExtractorDelegate> {
	...
	TNSRef<TICloudNoDocumentsViewController *> _iCloudNoDocumentsViewController;
	TNSRef<TDelayedPopulationViewController *> _delayedPopulationViewController;
	BOOL _isShowingICloudDriveContent;

}

@property (nonatomic,retain) TViewOptionsSettingsController * viewOptionsSettingsController;                //@synthesize viewOptionsSettingsController=_viewOptionsSettingsController - In the implementation block
...
@property (nonatomic,retain) TBrowserViewDataSource * dataSource; 
...
-(void)springNodeDetails:(const TFENode*)arg1 globalMouse:(const CGPoint*)arg2 spawnNewWindow:(BOOL)arg3 ;
-(void)springSidebarNode:(const TFENode*)arg1 globalMouse:(const CGPoint*)arg2 spawnNewWindow:(BOOL)arg3 ;
...
-(BOOL)validateToolbarEditTags:(id)arg1 ;
...
-(void)setViewOptionsSettingsController:(TViewOptionsSettingsController *)arg1 ;
...
-(void)reloadData;
-(void)setDataSource:(TBrowserViewDataSource *)arg1 ;
-(TBrowserViewDataSource *)dataSource;
-(id)nibName;
