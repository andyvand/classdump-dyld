...
@class NSDocumentRevisionsController, NSMutableArray, NSView, CALayer, NSMapTable, NSArray, NSTextField, NSButton, NSWindow;
...
@property (assign) unsigned long long currentStackItemIndex;              //@synthesize currentStackItemIndex=_currentStackItemIndex - In the implementation block
...
-(void)ensureSnapshotForStackItemAtIndex:(unsigned long long)arg1 forceNew:(char)arg2 wait:(char)arg3 ;
