...
@class NSAppearance, CALayer, NSResponder, NSDictionary, NSWindow, _NSViewAuxiliary, NSString, NSMenuItem, NSViewController, NSArray, CIFilter, NSShadow, NSScrollView, NSTextInputContext, NSURL;
...
-(void)performBlockForSelfAndRecursiveSubviews:(/*^block*/id)arg1 ;
-(char)satisfiesOrHasRecursiveSubviewSatisfyingBlock:(/*^block*/id)arg1 ;
...
-(CGRect)CalAlignmentRect;
-(void)CalAutoLayoutBeIntrinsicHeight;
-(void)CalAutoLayoutBeIntrinsicWidth;
-(CGSize)CalAutoLayoutSizeForDesiredFrameSize:(CGSize)arg1 ;
...
-(CGRect)SCTConvertToScreenRect:(CGRect)arg1 ;
