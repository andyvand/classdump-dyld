...
@class AVWeakReference, AVAsset, NSString, NSMutableArray, AVVideoComposition, AVCustomVideoCompositorSession;
...
@interface AVAssetImageGeneratorInternal : NSObject {
	...
	dispatch_queue_sRef requestsQueue;
	int nextRequestID;
	AVVideoComposition* videoComposition;
	AVCustomVideoCompositorSession* customVideoCompositorSession;
	dispatch_queue_sRef imageRequestQueue;
