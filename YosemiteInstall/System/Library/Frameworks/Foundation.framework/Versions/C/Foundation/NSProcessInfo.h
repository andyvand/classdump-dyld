...
@property (readonly) SCD_Struct_NS16 operatingSystemVersion; 
...
-(char)isOperatingSystemAtLeastVersion:(SCD_Struct_NS16)arg1 ;
-(char)isTranslated;
...
-(SCD_Struct_NS16)operatingSystemVersion;
