...
@property (assign) ICScannerDevice * scannerDevice;                                         //@synthesize scannerDevice=_scannerDevice - In the implementation block
...
@property (assign) char hasDisplayModeSimple;                                               //@synthesize hasDisplayModeSimple=_hasDisplayModeSimple - In the implementation block
@property (assign) char hasDisplayModeAdvanced;                                             //@synthesize hasDisplayModeAdvanced=_hasDisplayModeAdvanced - In the implementation block
...
@property (copy) NSString * scanControlLabel;                                               //@synthesize scanControlLabel=_scanControlLabel - In the implementation block
@property (copy) NSString * overviewControlLabel;                                           //@synthesize overviewControlLabel=_overviewControlLabel - In the implementation block
@property (copy) NSString * documentName;                                                   //@synthesize documentName=_documentName - In the implementation block
@property (assign) char displaysDocumentNameControl;                                        //@synthesize displaysDocumentNameControl=_displaysDocumentNameControl - In the implementation block
@property (assign) char displaysFileFormatControl;                                          //@synthesize displaysFileFormatControl=_displaysFileFormatControl - In the implementation block
...
@property (assign) char displaysImageCorrectionControl;                                     //@synthesize displaysImageCorrectionControl=_displaysImageCorrectionControl - In the implementation block
@property (assign) char displaysDeviceSelectorControl;                                      //@synthesize displaysDeviceSelectorControl=_displaysDeviceSelectorControl - In the implementation block
@property (assign) char displaysScanSizeControl;                                            //@synthesize displaysScanSizeControl=_displaysScanSizeControl - In the implementation block
@property (assign) char addAutoDetectionToScanSizeControl;                                  //@synthesize addAutoDetectionToScanSizeControl=_addAutoDetectionToScanSizeControl - In the implementation block
@property (assign) char displaysDoneButton;                                                 //@synthesize displaysDoneButton=_displaysDoneButton - In the implementation block
...
@property (copy) NSString * scanControlLabelDisplay;                                        //@synthesize scanControlLabelDisplay=_scanControlLabelDisplay - In the implementation block
@property (copy) NSString * overviewControlLabelDisplay;                                    //@synthesize overviewControlLabelDisplay=_overviewControlLabelDisplay - In the implementation block
