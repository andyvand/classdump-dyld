...
@property (nonatomic,copy) NSNumber * maxPassengerCount; 
@property (nonatomic,copy) NSString * medium; 
@property (nonatomic,copy) NSNumber * minPassengerCount; 
...
-(NSNumber *)maxPassengerCount;
-(void)setMaxPassengerCount:(NSNumber *)arg1 ;
-(NSNumber *)minPassengerCount;
-(void)setMinPassengerCount:(NSNumber *)arg1 ;
