...
@interface PASymbolDataStore : NSObject <PASerializable> {
	...
	char _shouldReportSymbolInformation;
	char _shouldDiscoverUncachedInformation;
...
@property (assign) char shouldDiscoverUncachedInformation;               //@synthesize shouldDiscoverUncachedInformation=_shouldDiscoverUncachedInformation - In the implementation block
@property (assign) char shouldReportSymbolInformation;                   //@synthesize shouldReportSymbolInformation=_shouldReportSymbolInformation - In the implementation block
...
-(char)shouldDiscoverUncachedInformation;
-(void)setShouldDiscoverUncachedInformation:(char)arg1 ;
-(char)shouldReportSymbolInformation;
-(void)setShouldReportSymbolInformation:(char)arg1 ;
...
-(id)_initWithShouldReportSymbolInformation:(char)arg1 ;
