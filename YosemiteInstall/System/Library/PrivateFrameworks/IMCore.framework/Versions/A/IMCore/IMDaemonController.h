...
@class IMRemoteObject, NSMutableDictionary, IMLocalObject, IMDaemonListener, NSMutableArray, NSProtocolChecker, NSString, NSRecursiveLock, NSArray, NSLock;
...
@interface IMDaemonController : NSObject {
	...
	dispatch_queue_sRef _listenerLockQueue;
	dispatch_queue_sRef _remoteDaemonLockQueue;
	dispatch_queue_sRef _localObjectLockQueue;
...
-(char)_blocksConnectionAtResume;
-(char)__isLocalObjectValidOnQueue:(dispatch_queue_sRef)arg1 ;
-(char)__isRemoteObjectValidOnQueue:(dispatch_queue_sRef)arg1 ;
