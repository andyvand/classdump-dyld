...
@property (nonatomic,readonly) SCD_Struct_GE75* tileUsages; 
...
-(void)addTileUsage:(SCD_Struct_GE75)arg1 ;
-(void)clearTileUsages;
-(unsigned long long)tileUsagesCount;
-(SCD_Struct_GE75)tileUsageAtIndex:(unsigned long long)arg1 ;
...
-(char)hasCellWifi;
-(SCD_Struct_GE75*)tileUsages;
-(void)setTileUsages:(SCD_Struct_GE75*)arg1 count:(unsigned long long)arg2 ;
-(char)hasHwMachine;
