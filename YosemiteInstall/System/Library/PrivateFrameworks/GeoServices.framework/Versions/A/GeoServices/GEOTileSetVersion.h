...
@property (nonatomic,readonly) SCD_Struct_GE75* genericTiles; 
...
-(SCD_Struct_GE75)genericTileAtIndex:(unsigned long long)arg1 ;
-(void)addGenericTile:(SCD_Struct_GE75)arg1 ;
...
-(SCD_Struct_GE75*)genericTiles;
-(void)setGenericTiles:(SCD_Struct_GE75*)arg1 count:(unsigned long long)arg2 ;
