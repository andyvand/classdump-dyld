...
@interface GEOTileGroup : PBCodable <NSCopying> {
	...
	SCD_Struct_GE68* _regionalResourceIndexs;
	unsigned long long _regionalResourceIndexsCount;
	unsigned long long _regionalResourceIndexsSpace;
	SCD_Struct_GE56* _attributionIndexs;
	SCD_Struct_GE56* _fontIndexs;
	SCD_Struct_GE56* _iconIndexs;
	SCD_Struct_GE56* _styleSheetIndexs;
	SCD_Struct_GE56* _textureIndexs;
	SCD_Struct_GE56* _xmlIndexs;
...
@property (nonatomic,readonly) SCD_Struct_GE68* regionalResourceIndexs; 
...
-(SCD_Struct_GE68)regionalResourceIndexAtIndex:(unsigned long long)arg1 ;
-(void)addRegionalResourceIndex:(SCD_Struct_GE68)arg1 ;
...
-(SCD_Struct_GE68*)regionalResourceIndexs;
-(void)setRegionalResourceIndexs:(SCD_Struct_GE68*)arg1 count:(unsigned long long)arg2 ;
-(unsigned*)xmlIndexs;
